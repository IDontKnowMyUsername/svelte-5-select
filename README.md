...
- **Svelte >= 5.57** (the component uses attachments, `class` objects, and template declaration tags); **Node >= 18 at runtime** (Svelte 5's own floor); **TypeScript >= 5.4** for the published types (they use `NoInfer`). Developing this repository needs Node >= 22.12.
