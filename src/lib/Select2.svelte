...
<div class="svelte-select" onpointerup={handleClick}>
    {#if listOpen}
        <div class="svelte-select-list" class:preFloat role="none" use:floatingContent bind:this={list}>
    ...
    <div class="value-container">
        <input bind:this={input} placeholder={placeholderText} style={inputStyles} {disabled} />
    </div>
</div>
